...
@interface EWSideMenuViewController ()
...
@implementation EWSideMenuViewController
...
- (void)commonInitialization
{
    ...
    self.animationType = EWSideMenuAnimationTypeSlideOver;
...
- (void)setMainViewController:(UIViewController *)mainViewController animated:(BOOL)animated closeMenu:(BOOL)closeMenu
{
    ...
    switch (self.animationType) {
        case EWSideMenuAnimationTypeSlideOver: {
        ...
        case EWSideMenuAnimationTypeFadeIn:
...
@implementation UIViewController (EWSideMenuViewController)

- (void)setSideMenuViewController:(EWSideMenuViewController *)sideMenuViewController
{
    objc_setAssociatedObject(self, @selector(sideMenuViewController), sideMenuViewController, OBJC_ASSOCIATION_ASSIGN);
}

- (EWSideMenuViewController *)sideMenuViewController
{
    EWSideMenuViewController *sideMenuController = objc_getAssociatedObject(self, @selector(sideMenuViewController));
